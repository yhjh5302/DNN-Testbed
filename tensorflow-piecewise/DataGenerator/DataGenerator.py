...
if __name__ == "__main__":
    ...
    parser.add_argument('--alexnet_prev_addr', default='localhost', type=str, help='Previous node address')
    parser.add_argument('--alexnet_prev_port', default=30000, type=int, help='Previous node port')
    parser.add_argument('--alexnet_next_addr', default='localhost', type=str, help='Next node address')
    parser.add_argument('--alexnet_next_port', default=30001, type=int, help='Next node port')
    parser.add_argument('--googlenet_prev_addr', default='localhost', type=str, help='Previous node address')
    parser.add_argument('--googlenet_prev_port', default=30010, type=int, help='Previous node port')
    parser.add_argument('--googlenet_next_addr', default='localhost', type=str, help='Next node address')
    parser.add_argument('--googlenet_next_port', default=30011, type=int, help='Next node port')
    parser.add_argument('--vggnet_prev_addr', default='localhost', type=str, help='Previous node address')
    parser.add_argument('--vggnet_prev_port', default=30020, type=int, help='Previous node port')
    parser.add_argument('--vggnet_next_addr', default='localhost', type=str, help='Next node address')
    parser.add_argument('--vggnet_next_port', default=30021, type=int, help='Next node port')
    parser.add_argument('--alexnet_block', default=True, type=str2bool, help='block?')
    parser.add_argument('--googlenet_block', default=True, type=str2bool, help='block?')
    parser.add_argument('--vggnet_block', default=True, type=str2bool, help='block?')
