...
if __name__ == "__main__":
    ...
    parser.add_argument('--next_addr', default='10.96.0.232', type=str, help='Next node address')
    parser.add_argument('--next_port', default=30032, type=int, help='Next node port')
    ...
    # model loading
    model = VGGNet_layer_1(name='layer1')
    model.features1.load_weights('./VGGNet_features1_weights')
    model.features2.load_weights('./VGGNet_features2_weights')
    model.features3.load_weights('./VGGNet_features3_weights')
