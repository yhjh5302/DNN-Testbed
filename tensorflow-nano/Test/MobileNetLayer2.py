...
if __name__ == "__main__":
    ...
    parser.add_argument('--prev_addr', default='10.96.0.222', type=str, help='Previous node address')
    parser.add_argument('--prev_port', default=30022, type=int, help='Previous node port')
    parser.add_argument('--next_addr', default='10.96.0.223', type=str, help='Next node address')
    parser.add_argument('--next_port', default=30023, type=int, help='Next node port')
    ...
    # model loading
    model = MobileNet_layer_2(name='layer2')
