...
if __name__ == "__main__":
    ...
    parser.add_argument('--prev_addr', default='10.96.0.232', type=str, help='Previous node address')
    parser.add_argument('--prev_port', default=30032, type=int, help='Previous node port')
    parser.add_argument('--next_addr', default='10.96.0.233', type=str, help='Next node address')
    parser.add_argument('--next_port', default=30033, type=int, help='Next node port')
    parser.add_argument('--vram_limit', default=128, type=int, help='Next node port')
    ...
    # model loading
    model = VGGNet_layer_2(name='layer2')
    model.features4.load_weights('./VGGNet_features4_weights')
    model.features5.load_weights('./VGGNet_features5_weights')

    # for cuDNN loading
    model(np.zeros((1,28,28,256)))
    ...
    try:
        for _ in range(1000):
            ...
            inputs = tf.random.uniform(shape=[1,28,28,256])
