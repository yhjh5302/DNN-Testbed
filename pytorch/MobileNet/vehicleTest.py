...
from vehicleTrain import calculate_norm
...
if __name__ == '__main__':
    ...
    model.conv1.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_conv1.pth'))
    model.separable_conv2.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv2.pth'))
    model.separable_conv3.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv3.pth'))
    model.separable_conv4.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv4.pth'))
    model.separable_conv5.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv5.pth'))
    model.separable_conv6.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv6.pth'))
    model.separable_conv7.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv7.pth'))
    model.separable_conv8.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv8.pth'))
    model.separable_conv9.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv9.pth'))
    model.separable_conv10.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv10.pth'))
    model.separable_conv11.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv11.pth'))
    model.separable_conv12.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv12.pth'))
    model.separable_conv13.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv13.pth'))
    model.separable_conv14.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_separable_conv14.pth'))
    model.fc.load_state_dict(torch.load(PATH + '/vehicle_MobileNetV1_fc.pth'))
