...
if __name__ == '__main__':
    ...
    features1.load_state_dict(torch.load(PATH + 'cifar_VGGFNet_features1.pth'))
    features2.load_state_dict(torch.load(PATH + 'cifar_VGGFNet_features2.pth'))
    features3.load_state_dict(torch.load(PATH + 'cifar_VGGFNet_features3.pth'))
    features4.load_state_dict(torch.load(PATH + 'cifar_VGGFNet_features4.pth'))
    features5.load_state_dict(torch.load(PATH + 'cifar_VGGFNet_features5.pth'))
    classifier1.load_state_dict(torch.load(PATH + 'cifar_VGGFNet_classifier1.pth'))
    classifier2.load_state_dict(torch.load(PATH + 'cifar_VGGFNet_classifier2.pth'))
    classifier3.load_state_dict(torch.load(PATH + 'cifar_VGGFNet_classifier3.pth'))
