...
if __name__ == '__main__':
    ...
    PATH = './'
    torch.save(model.features1.state_dict(), PATH + 'cifar_AlexNet_features1.pth')
    torch.save(model.features2.state_dict(), PATH + 'cifar_AlexNet_features2.pth')
    torch.save(model.features3.state_dict(), PATH + 'cifar_AlexNet_features3.pth')
    torch.save(model.features4.state_dict(), PATH + 'cifar_AlexNet_features4.pth')
    torch.save(model.features5.state_dict(), PATH + 'cifar_AlexNet_features5.pth')
    torch.save(model.classifier1.state_dict(), PATH + 'cifar_AlexNet_classifier1.pth')
    torch.save(model.classifier2.state_dict(), PATH + 'cifar_AlexNet_classifier2.pth')
    torch.save(model.classifier3.state_dict(), PATH + 'cifar_AlexNet_classifier3.pth')
