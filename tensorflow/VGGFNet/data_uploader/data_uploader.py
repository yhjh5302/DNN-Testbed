...
if __name__ == "__main__":
    ...
    parser.add_argument('--prev_port', default=30040, type=int, help='Previous node port')
    parser.add_argument('--next_addr', default='10.96.0.241', type=str, help='Next node address')
    parser.add_argument('--next_port', default=30041, type=int, help='Next node port')
