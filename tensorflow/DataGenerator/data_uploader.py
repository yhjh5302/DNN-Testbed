...
if __name__ == "__main__":
    ...
    parser.add_argument('--prev_port', default=30000, type=int, help='Previous node port')
    parser.add_argument('--next_addr', default='10.96.0.201', type=str, help='Next node address')
    parser.add_argument('--next_port', default=30001, type=int, help='Next node port')
