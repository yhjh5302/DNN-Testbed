...
if __name__ == "__main__":
    ...
    parser.add_argument('--alexnet_block', default=False, type=str2bool, help='block?')
    parser.add_argument('--googlenet_block', default=False, type=str2bool, help='block?')
    parser.add_argument('--mobilenet_block', default=False, type=str2bool, help='block?')
    parser.add_argument('--vggnet_block', default=False, type=str2bool, help='block?')
    parser.add_argument('--vggfnet_block', default=False, type=str2bool, help='block?')
