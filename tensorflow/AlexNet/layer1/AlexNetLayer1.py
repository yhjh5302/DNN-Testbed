...
if __name__ == "__main__":
    ...
    parser.add_argument('--next_addr', default='10.96.0.202', type=str, help='Next node address')
    parser.add_argument('--next_port', default=30002, type=int, help='Next node port')
    ...
    # model loading
    model = AlexNet_layer_1(name='layer1')
    model.features_1.load_weights('./alexnet_features_1_weights')
    model.features_2.load_weights('./alexnet_features_2_weights')
