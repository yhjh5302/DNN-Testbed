...
if __name__ == "__main__":
    ...
    parser.add_argument('--prev_addr', default='10.96.0.223', type=str, help='Previous node address')
    parser.add_argument('--prev_port', default=30023, type=int, help='Previous node port')
    ...
    # model loading
    model = MobileNet_layer_3(name='layer3')
    ...
    try:
        for _ in range(1000):
            ...
            inputs = tf.random.uniform(shape=[1,14,14,512])
